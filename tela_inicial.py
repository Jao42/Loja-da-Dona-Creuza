...
def telaInicial():
  ...
  Label(Left, text=
  """
  A LOJINHA DA DONA CREUZA É UMA LOJA VIRTUAL DE VARIEDADES.
  AQUI VOCÊ ENCONTRARÁ DE PRODUTOS ELETRÔNICOS A ALIMENTOS.
  POSSUÍMOS MARCAS DE QUALIDADE E NOSSO ATENDIMENTO É PENSADO
  NO BEM ESTAR DOS NOSSOS CLIENTES, ALÉM DE POSSUÍRMOS PROMOÇÕES
